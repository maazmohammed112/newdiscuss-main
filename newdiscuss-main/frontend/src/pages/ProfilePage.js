...
import { 
  ...
  Info, Mail, Image as ImageIcon, Users, UserPlus, Search, Clock, MessageCircle, Share2, Bell, ArrowLeft, MoreHorizontal
} from 'lucide-react';
      ...
      <div className="max-w-xl mx-auto px-4 py-6 md:py-10">
        ...
        <div className="bg-white dark:bg-[#1E293B] discuss:bg-[#1a1a1a] shadow-[0_4px_24px_rgba(0,0,0,0.06)] dark:shadow-none discuss:shadow-none border discuss:border discuss:border-[#333333] p-8 text-center relative rounded-2xl">
          ...
          {user?.photo_url ? (
            ...
            >
              <img referrerPolicy="no-referrer" crossOrigin="anonymous" src={user.photo_url} alt={user.username} className="w-24 h-24 mx-auto shadow-lg discuss:shadow-none object-cover discuss:border discuss:border-[#333333] rounded-full group-hover:opacity-90 transition-opacity" />
                    ...
                    {receivedRequests.map((request) => {
                      ...
                      return (
                        <div key={request.fromUserId} className="flex items-center justify-between bg-white dark:bg-[#1E293B] discuss:bg-[#1a1a1a] p-3 rounded-lg border border-[#E2E8F0] dark:border-[#334155] discuss:border-[#333333]">
                          ...
                          >
                            {reqUser?.photo_url ? (
                              <img referrerPolicy="no-referrer" crossOrigin="anonymous" src={reqUser.photo_url} alt={reqUser.username} className="w-10 h-10 rounded-full object-cover" />
                            ) : (
                          ...
                          {suggestedFriends.map((suggested) => {
                            ...
                            return (
                              <div key={suggested.id} className="flex items-center justify-between bg-[#F5F5F7] dark:bg-[#0F172A] discuss:bg-[#262626] p-3 rounded-lg">
                                ...
                                >
                                  {suggested.photo_url ? (
                                    <img referrerPolicy="no-referrer" crossOrigin="anonymous" src={suggested.photo_url} alt={suggested.username} className="w-10 h-10 rounded-full object-cover" />
                                  ) : (
                    ...
                    {friends.map((friend) => {
                      ...
                      return (
                        <div key={friend.id} className="flex items-center justify-between bg-[#F5F5F7] dark:bg-[#0F172A] discuss:bg-[#262626] p-3 rounded-lg">
                          ...
                          >
                            {friend.photo_url ? (
                              <img referrerPolicy="no-referrer" crossOrigin="anonymous" src={friend.photo_url} alt={friend.username} className="w-10 h-10 rounded-full object-cover" />
                            ) : (
                              <div className="w-10 h-10 rounded-full bg-[#2563EB] discuss:bg-[#EF4444] flex items-center justify-center">
                                <span className="text-white text-sm font-bold">{initials}</span>
                              </div>
